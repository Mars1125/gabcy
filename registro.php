                ...
                <form class="custom-form donate-form" action="./php/registro.php" method="POST" role="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mt-2">
                            ...
                            <input type="text" name="nombres" id="nombres" class="form-control" placeholder="John"
                                required="">
                        </div>

                        <div class="col-lg-6 col-12 mt-2">
                            <label for="apellidos">Apellidos</label>
                            <input type="text" name="apellidos" id="apellidos" class="form-control" placeholder="Doe"
                                required="">
                        </div>
                        ...
                        <div class="col-lg-6 col-12 mt-2">
                            ...
                            <input type="text" name="telefono" id="telefono" class="form-control"
                                placeholder="+52 5555 5555" required="">
                        </div>
                        ...
                        <div class="col-lg-6 col-12 mt-2">
                            ...
                            <input type="text" name="empresa" id="empresa" class="form-control" placeholder="Mi empresa"
                                required="">
                        </div>

                        <div class="col-lg-6 col-12 mt-2">
                            <label for="cargo">Cargo</label>
                            <input type="text" name="cargo" id="cargo" class="form-control" placeholder="Director"
                                required="">
                        </div>
                        <div class="col-lg-12 col-12">
